//face矩陣名：0.angry1  1.angry2  2.blink2  3.blink3  4.happy1  5.happy2  6.normal1  7.normal2  8.normal3  9.unhappy1   10.unhappy2  11.unhappy3  12.hungry1  13.hungry2  14.wakeup1  15.wakeup2  16.wakeup3  17.happy_11  18.happy_12
//函式名稱：Wakeup()  Angry()  Blink()  Happy()  Happy1()  Unhappy()  Normal()  Hungry()  Left()  Right()
#include"picture.h"
void Wakeup(){
    display.clear();
